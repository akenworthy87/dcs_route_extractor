Feature: Waypoint conversions for SinaiMap
  ...
  Scenario: Waypoint 0
    ...
    And MGRS GRID: 36R UU 30777 25312
  ...
  Scenario: Waypoint 1
    ...
    And MGRS GRID: 35R QQ 22908 76942
  ...
  Scenario: Waypoint 2
    ...
    And MGRS GRID: 36R XV 57825 67412
  ...
  Scenario: Waypoint 3
    ...
    And MGRS GRID: 36R YQ 87601 94339
  ...
  Scenario: Waypoint 4
    ...
    And MGRS GRID: 36R TQ 76954 67236
